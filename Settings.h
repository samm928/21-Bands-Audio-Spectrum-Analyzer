...
#pragma once
char version[]="5.21";                              // Define version number for reference only
...
#define BRIGHTNESSMAX     25                        // Max brightness of the leds...carefull...to bright might draw to much amps!
...
//Controls  *************************************************************************************************************
#define SENSITIVITYPOT    A3                        // Potmeter for sensitivity input 0...5V (0-3.3V on ESP32)
#define BRIGHTNESSPOT     A2                        // Potmeter for Brightness input 0...5V (0-3.3V on ESP32)  
#define PEAKDELAYPOT      A4                        // Potmeter for Peak Delay Time input 0...5V (0-3.3V on ESP32)
